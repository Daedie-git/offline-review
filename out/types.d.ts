...
export declare function getReviewSourceTarget(review: LocalPr): ReviewSourceTarget;
/** The single user-facing label format for persisted reviews. */
export declare function formatReviewLabel(review: LocalPr): string;
...
export type ReviewAnchorStatus = 'current' | 'reanchored' | 'legacyCurrent' | 'notFound' | 'ambiguous' | 'unavailable';
