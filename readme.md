...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/Gururagavendra/vscode-local-pr-reviewer/blob/HEAD/LICENSE)
...
![Local PR Review in action](https://github.com/Gururagavendra/vscode-local-pr-reviewer/raw/HEAD/resources/screenshots/demo.gif)
...
![Time Comparison: Remote API vs Local Storage](https://github.com/Gururagavendra/vscode-local-pr-reviewer/raw/HEAD/resources/graphs/time-comparison.png)
...
For the full detailed architecture diagram including data flows and module map, see [ARCHITECTURE.md](https://github.com/Gururagavendra/vscode-local-pr-reviewer/blob/HEAD/ARCHITECTURE.md).
